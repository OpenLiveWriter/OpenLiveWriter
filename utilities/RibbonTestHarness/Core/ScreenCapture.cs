...
public static class ScreenCapture
{
    ...
    /// <summary>
    /// Captures the ribbon area from a process
    /// </summary>
    public static Bitmap? CaptureProcessRibbon(Process? process, int ribbonHeight = 150)
    {
        if (process == null || process.HasExited)
            return null;
            
        return CaptureRibbonArea(process.MainWindowHandle, ribbonHeight);
    }
