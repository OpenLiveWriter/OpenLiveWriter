...
namespace mshtml
{
    ...
    [ComImport, InterfaceType((short) 2), TypeLibType((short) 0x1010), Guid("3050F525-98B5-11CF-BB82-00AA00BDCE0B")]
    public interface DispHTMLListElement
    {
        ...
        [DispId(0x3e9)]
        bool compact { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e9), TypeLibFunc((short) 4)] set; [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e9), TypeLibFunc((short) 4)] get; }
    }
}
