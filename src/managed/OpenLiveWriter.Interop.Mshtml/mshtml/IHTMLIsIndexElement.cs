...
namespace mshtml
{
    ...
    [ComImport, TypeLibType((short) 0x1040), Guid("3050F206-98B5-11CF-BB82-00AA00BDCE0B")]
    public interface IHTMLIsIndexElement
    {
        [DispId(0x3f2)]
        string prompt { [param: In, MarshalAs(UnmanagedType.BStr)] [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3f2), TypeLibFunc((short) 20)] set; [return: MarshalAs(UnmanagedType.BStr)] [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), TypeLibFunc((short) 20), DispId(0x3f2)] get; }
        [DispId(0x3f3)]
