...
namespace mshtml
{
    ...
    [ComImport, TypeLibType((short) 0x1010), Guid("3050F51B-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType((short) 2)]
    public interface DispHTMLIFrame
    {
        ...
        [DispId(-2147414111)]
        int vspace { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-2147414111)] set; [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-2147414111)] get; }
        [DispId(-2147414110)]
        int hspace { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-2147414110)] set; [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-2147414110)] get; }
        [DispId(-2147418039)]
