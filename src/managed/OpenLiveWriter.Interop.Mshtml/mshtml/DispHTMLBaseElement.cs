...
namespace mshtml
{
    ...
    [ComImport, InterfaceType((short) 2), TypeLibType((short) 0x1010), Guid("3050F518-98B5-11CF-BB82-00AA00BDCE0B")]
    public interface DispHTMLBaseElement
    {
        ...
        [DispId(0x3ec)]
        string target { [param: MarshalAs(UnmanagedType.BStr)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3ec), TypeLibFunc((short) 20)] set; [return: MarshalAs(UnmanagedType.BStr)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3ec), TypeLibFunc((short) 20)] get; }
    }
}
