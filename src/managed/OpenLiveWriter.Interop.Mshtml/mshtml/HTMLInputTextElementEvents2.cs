...
namespace mshtml
{
    ...
    [ComImport, Guid("3050F618-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType((short) 2), TypeLibType((short) 0x1010)]
    public interface HTMLInputTextElementEvents2
    {
        ...
        bool onchange([In, MarshalAs(UnmanagedType.Interface)] IHTMLEventObj pEvtObj);
        ...
        void onabort([In, MarshalAs(UnmanagedType.Interface)] IHTMLEventObj pEvtObj);
    }
}
