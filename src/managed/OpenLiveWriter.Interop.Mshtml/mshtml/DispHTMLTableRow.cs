...
namespace mshtml
{
    ...
    [ComImport, TypeLibType((short) 0x1010), Guid("3050F535-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType((short) 2)]
    public interface DispHTMLTableRow
    {
        ...
        [DispId(0x3e8)]
        int rowIndex { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e8)] get; }
        [DispId(0x3e9)]
        int sectionRowIndex { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e9)] get; }
        [DispId(0x3ea)]
        IHTMLElementCollection cells { [return: MarshalAs(UnmanagedType.Interface)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3ea)] get; }
        [return: MarshalAs(UnmanagedType.IDispatch)]
        ...
        [DispId(0x3f2)]
        string chOff { [param: MarshalAs(UnmanagedType.BStr)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), TypeLibFunc((short) 20), DispId(0x3f2)] set; [return: MarshalAs(UnmanagedType.BStr)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3f2), TypeLibFunc((short) 20)] get; }
    }
}
