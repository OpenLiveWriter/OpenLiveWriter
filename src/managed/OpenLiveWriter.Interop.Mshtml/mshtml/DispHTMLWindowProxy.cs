...
namespace mshtml
{
    ...
    [ComImport, Guid("3050F55E-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType((short) 2), DefaultMember("item"), TypeLibType((short) 0x1010)]
