...
namespace mshtml
{
    ...
    [ComImport, TypeLibType((short) 0x1010), InterfaceType((short) 2), Guid("3050F50B-98B5-11CF-BB82-00AA00BDCE0B")]
    public interface DispHTMLDDElement
    {
        ...
        [DispId(-2147413107)]
        bool noWrap { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), TypeLibFunc((short) 20), DispId(-2147413107)] set; [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), TypeLibFunc((short) 20), DispId(-2147413107)] get; }
    }
}
