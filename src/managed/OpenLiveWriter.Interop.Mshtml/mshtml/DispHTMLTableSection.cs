...
namespace mshtml
{
    ...
    [ComImport, TypeLibType((short) 0x1010), InterfaceType((short) 2), Guid("3050F534-98B5-11CF-BB82-00AA00BDCE0B")]
    public interface DispHTMLTableSection
    {
        ...
        [DispId(0x3e8)]
        IHTMLElementCollection rows { [return: MarshalAs(UnmanagedType.Interface)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e8)] get; }
        [return: MarshalAs(UnmanagedType.IDispatch)]
