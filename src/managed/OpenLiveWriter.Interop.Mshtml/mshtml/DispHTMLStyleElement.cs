...
namespace mshtml
{
    ...
    [ComImport, Guid("3050F511-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType((short) 2), TypeLibType((short) 0x1010)]
    public interface DispHTMLStyleElement
    {
        ...
        [DispId(0x3ec)]
        IHTMLStyleSheet styleSheet { [return: MarshalAs(UnmanagedType.Interface)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3ec)] get; }
        [DispId(0x3ee)]
