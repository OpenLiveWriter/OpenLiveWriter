...
namespace mshtml
{
    ...
    [ComImport, InterfaceType((short) 2), Guid("3050F614-98B5-11CF-BB82-00AA00BDCE0B"), TypeLibType((short) 0x1010)]
    public interface HTMLFormElementEvents2
    {
        ...
        bool onsubmit([In, MarshalAs(UnmanagedType.Interface)] IHTMLEventObj pEvtObj);
        [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3f7)]
        bool onreset([In, MarshalAs(UnmanagedType.Interface)] IHTMLEventObj pEvtObj);
    }
}
