...
namespace mshtml
{
    ...
    [ComImport, Guid("3050F53D-98B5-11CF-BB82-00AA00BDCE0B"), InterfaceType((short) 2), TypeLibType((short) 0x1010)]
    public interface DispHTMLHRElement
    {
        ...
        [DispId(0x3e9)]
        bool noShade { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), TypeLibFunc((short) 4), DispId(0x3e9)] set; [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e9), TypeLibFunc((short) 4)] get; }
        [DispId(-2147418107)]
