...
namespace mshtml
{
    ...
    [ComImport, InterfaceType((short) 2), Guid("3050F563-98B5-11CF-BB82-00AA00BDCE0B"), TypeLibType((short) 0x1010)]
    public interface DispHTMLGenericElement
    {
        ...
        [DispId(0x3e9)]
        object recordset { [return: MarshalAs(UnmanagedType.IDispatch)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), TypeLibFunc((short) 0x40), DispId(0x3e9)] get; }
        [return: MarshalAs(UnmanagedType.IDispatch)]
