...
namespace mshtml
{
    ...
    [ComImport, TypeLibType((short) 0x1010), InterfaceType((short) 2), Guid("3050F533-98B5-11CF-BB82-00AA00BDCE0B")]
    public interface DispHTMLTableCol
    {
        ...
        [DispId(0x3e9)]
        int span { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e9)] set; [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3e9)] get; }
        [DispId(-2147418107)]
