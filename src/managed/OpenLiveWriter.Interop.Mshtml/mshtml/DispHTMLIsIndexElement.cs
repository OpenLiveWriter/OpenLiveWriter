...
namespace mshtml
{
    ...
    [ComImport, InterfaceType((short) 2), Guid("3050F519-98B5-11CF-BB82-00AA00BDCE0B"), TypeLibType((short) 0x1010)]
    public interface DispHTMLIsIndexElement
    {
        ...
        [DispId(0x3f4)]
        IHTMLFormElement form { [return: MarshalAs(UnmanagedType.Interface)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3f4)] get; }
    }
}
