...
namespace mshtml
{
    ...
    [ComImport, TypeLibType((short) 0x1010), InterfaceType((short) 2), Guid("3050F526-98B5-11CF-BB82-00AA00BDCE0B")]
    public interface DispHTMLMapElement
    {
        ...
        [DispId(0x3ea)]
        IHTMLAreasCollection areas { [return: MarshalAs(UnmanagedType.Interface)] [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(0x3ea)] get; }
        [DispId(-2147418112)]
