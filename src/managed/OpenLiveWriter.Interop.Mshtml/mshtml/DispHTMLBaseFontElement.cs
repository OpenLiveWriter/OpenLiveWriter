...
namespace mshtml
{
    ...
    [ComImport, InterfaceType((short) 2), Guid("3050F504-98B5-11CF-BB82-00AA00BDCE0B"), TypeLibType((short) 0x1010)]
    public interface DispHTMLBaseFontElement
    {
        ...
        [DispId(-2147413086)]
        int size { [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-2147413086), TypeLibFunc((short) 20)] set; [PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType=MethodCodeType.Runtime), DispId(-2147413086), TypeLibFunc((short) 20)] get; }
    }
}
