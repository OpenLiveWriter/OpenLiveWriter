...
{
    /// <summary>
    /// The ApplicationWorkspaceControl control provides a multi-pane workspace, with an optional
    /// command bar.
    /// </summary>
    public class ApplicationWorkspaceControl : OpenLiveWriter.Controls.LightweightControlContainerControl
    {
        /// <summary>
        ...
        /// </summary>
        private Size columnLayoutMargin = new Size(3, 3);
        ...
        public CommandBarDefinition CommandBarDefinition
        {
            get
            {
                return applicationWorkspaceCommandBarLightweightControl.CommandBarDefinition;
            }
            set
            {
                applicationWorkspaceCommandBarLightweightControl.CommandBarDefinition = value;
                PerformLayout();
                Invalidate();
            }
        }
        ...
        /// </summary>
        private OpenLiveWriter.ApplicationFramework.ApplicationWorkspaceCommandBarLightweightControl applicationWorkspaceCommandBarLightweightControl;
        ...
        /// <summary>
        /// Initializes a new instance of the ApplicationWorkspaceControl class.
        /// </summary>
        public ApplicationWorkspaceControl()
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.applicationWorkspaceCommandBarLightweightControl = new OpenLiveWriter.ApplicationFramework.ApplicationWorkspaceCommandBarLightweightControl(this.components);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.applicationWorkspaceCommandBarLightweightControl)).BeginInit();
            ...
            //
            // applicationWorkspaceCommandBarLightweightControl
            //
            this.applicationWorkspaceCommandBarLightweightControl.LayoutMargin = new System.Drawing.Size(1, 2);
            this.applicationWorkspaceCommandBarLightweightControl.LightweightControlContainerControl = this;
            this.applicationWorkspaceCommandBarLightweightControl.Visible = false;
            //
            // leftColumn
            //
            ...
            this.Name = "ApplicationWorkspaceControl";
            this.Size = new System.Drawing.Size(294, 286);
            ((System.ComponentModel.ISupportInitialize)(this.applicationWorkspaceCommandBarLightweightControl)).EndInit();
        ...
        protected override void OnLayout(LayoutEventArgs e)
        {
            ...
            //	Layout the application workspace command bar lightweight control.  The return is the column
            //	layout rectangle.
            Rectangle columnLayoutRectangle = LayoutApplicationWorkspaceCommandBar();
        ...
        /// <summary>
        /// Layout the application workspace command bar.
        /// </summary>
        /// <returns>Column layout rectangle.</returns>
        private Rectangle LayoutApplicationWorkspaceCommandBar()
        {
            //	The application workspace command bar height (set below).
            int applicationWorkspaceCommandBarHeight = 0;

            //	If we have an application workspace command bar lightweight control, lay it out.
            if (applicationWorkspaceCommandBarLightweightControl != null)
            {
                //	If a command bar definition has been supplied, layout the application workspace
                //	command bar lightweight control. Otherwise, hide it.
                if (CommandBarDefinition != null)
                {
                    //	Set the application command bar height.
                    applicationWorkspaceCommandBarHeight = applicationWorkspaceCommandBarLightweightControl.DefaultVirtualSize.Height;

                    //	Layout the application workspace command bar lightweight control.
                    applicationWorkspaceCommandBarLightweightControl.Visible = true;
                    applicationWorkspaceCommandBarLightweightControl.VirtualBounds = new Rectangle(0, 0, Width, applicationWorkspaceCommandBarHeight);
                }
                else
                {
                    //	Layout the application workspace command bar lightweight control.
                    applicationWorkspaceCommandBarLightweightControl.Visible = false;
                    applicationWorkspaceCommandBarLightweightControl.VirtualBounds = Rectangle.Empty;
                }
            }

            //	Return the column layout rectangle.
            return new Rectangle(	columnLayoutMargin.Width,
                                    applicationWorkspaceCommandBarHeight+columnLayoutMargin.Height,
                                    Width-(columnLayoutMargin.Width*2),
                                    Height-applicationWorkspaceCommandBarHeight-(columnLayoutMargin.Height*2));
        }
