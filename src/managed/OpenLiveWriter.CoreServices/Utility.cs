...
namespace OpenLiveWriter.CoreServices
{
    ...
    public sealed class Utility
    {
        ...
        /// <param name="rectangle">The area within which the thing should be centered.</param>
        /// <returns>The bounds that should be applied to the thing being centered.</returns>
        public static RectangleF CenterInRectangleF(SizeF size, RectangleF rectangle)
        {
            PointF center = Center(rectangle);
            return CenterAroundPointF(size, center);
        }
        ...
        /// <param name="point">The point around which the thing should be centered.</param>
        /// <returns>The bounds that should be applied to the thing being centered.</returns>
        public static RectangleF CenterAroundPointF(SizeF size, PointF point)
        {
            float x = point.X - (size.Width / 2);
            float y = point.Y - (size.Height / 2);
        ...
        /// Returns the center point of a rectangle.
        /// </summary>
        public static PointF Center(RectangleF bounds)
        {
            return new PointF((bounds.X * 2 + bounds.Width) / 2, (bounds.Y * 2 + bounds.Height) / 2);
        }
