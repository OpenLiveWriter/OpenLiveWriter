...
{
    /// <summary>
    /// Defines additional dataformat constants describing commonly used
    /// dataobject (clipboard) formats.
    /// </summary>
    public class DataFormatsEx
    {
        /// <summary>
        /// Constants representing formats used by the clipboard
        /// </summary>
