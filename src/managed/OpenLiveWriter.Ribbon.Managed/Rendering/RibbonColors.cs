...
namespace OpenLiveWriter.Ribbon.Managed.Rendering
{
    ...
    public class RibbonColors
    {
        ...
        // Button colors - Native Windows Ribbon style (subtle highlights)
        public Color ButtonBackground { get; set; } = Color.Transparent;
        public Color ButtonBackgroundHover { get; set; } = Color.FromArgb(229, 241, 251);
        public Color ButtonBackgroundPressed { get; set; } = Color.FromArgb(204, 228, 247);
        public Color ButtonBackgroundChecked { get; set; } = Color.FromArgb(213, 233, 249);
        public Color ButtonBorder { get; set; } = Color.Transparent;
        public Color ButtonBorderHover { get; set; } = Color.FromArgb(194, 224, 248);
        public Color ButtonBorderPressed { get; set; } = Color.FromArgb(152, 198, 234);
        public Color ButtonBorderChecked { get; set; } = Color.FromArgb(163, 209, 242);
        ...
        public Color QatButtonBackgroundHover { get; set; } = Color.FromArgb(229, 241, 251);
        public Color QatButtonBackgroundPressed { get; set; } = Color.FromArgb(204, 228, 247);
        public Color QatButtonBorderHover { get; set; } = Color.FromArgb(194, 224, 248);
        public Color QatButtonBorderPressed { get; set; } = Color.FromArgb(152, 198, 234);
        ...
        // Separator colors (in-group separators - match native ribbon)
        public Color Separator { get; set; } = Color.FromArgb(220, 220, 220);
