...
namespace OpenLiveWriter.Ribbon.Managed.Controls
{
    ...
    public static class LayoutConstants
    {
        ...
        private const int BASE_GroupPadding = 3; // Compact padding to match native ribbon
        ...
        private const int BASE_GroupSeparatorMargin = 2;
        private const int BASE_GroupMinWidth = 40;
        private const int BASE_GroupLabelHeight = 16;
        private const int BASE_PopupWidth = 38;
        private const int BASE_TabHeight = 24;
        private const int BASE_ContentHeight = 92;   // Native ribbon content area is ~92px at 100% DPI
